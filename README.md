...
- 五茶 / 男 / 2001
- 本科主动退学 / 福建理工大学 物联网工程 2019 年入学
- Github：[https://github.com/PentaTea](https://github.com/PentaTea)
- 现居北京 / 接受其他城市
- 期望职位：前端开发工程师 / 全栈工程师 / UX设计师 / 产品总监 `(但是这篇简历是for前端的啦)`
...
1. 飞书词典 __业务 owner & main contact__
2. 承接词典在 __飞书文档__ 侧的所有需求迭代
3. 负责团队多业务的 __工程建设__, focus 在 __架构设计, 团队效率, 交付质量, 性能与监控等__

影响: 
1. 产品迭代: `指标保密不能说啊`
2. 质量建设:
   - 主动识别发版流程损耗, 制订并落地规范与班车制度, 搭建自动化与审批卡点, 培养外包人力
   - 尝试质量左移, 从零搞质量周报, 归因等
   - 搭建前端 SLA 体系, 设计埋点, 建立大盘监控报警
   - 🍰 成果:
     - 发版正式员工人力: 每周 1~2天 -> 0天
     - 报警流程翻新, MTTI 15分钟 -> 3分钟以内
     - 季度严重 bug 率从 25% 降低到 4% (用时半年)
     - 半年周期线上 badcase 数量: 7个 -> 1个 (用时1年)
  3. 架构优化
     - 优化封装, 代码和类型自动生成, 节省存量代码超 7000 行, 降低飞书文档首屏体积 30kB (原总量约 50kB, 其他项目均有接入, 但对首屏没那么严格)
